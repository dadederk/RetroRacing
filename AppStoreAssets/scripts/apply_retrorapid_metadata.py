...
Crash, restart, and beat your best.""",
    ...
    "en-GB": LocalePack(
        ...
        name="RetroRapid: Arcade Racer",
        subtitle="Dodge Traffic Across 3 Lanes",
        keywords="endless,chase,watch,game,accessible,swift,classic,pixel,boost,nostalgia,highway,skill,vintage,drive",
        promotional_text="Dodge traffic and chase high scores in quick retro races, with Game Center, Apple Watch support, and accessibility-first controls.",
        description="""RetroRapid! is a fast 3-lane arcade racer built for quick sessions and high-score chasing.
...
Crash, restart, and beat your best.""",
    ...
    "en-AU": LocalePack(
        ...
        name="RetroRapid: Arcade Racer",
        subtitle="Dodge Traffic Across 3 Lanes",
        keywords="chase,watch,game,reflex,classic,pixel,vintage,boost,nostalgia,mobile,quick,endless,skill,overtake",
        promotional_text="Dodge traffic and chase high scores in quick retro races, with Game Center, Apple Watch support, and accessibility-first controls.",
        description="""RetroRapid! is a fast 3-lane arcade racer built for quick sessions and high-score chasing.
...
Crash, restart, and beat your best.""",
    ...
    "en-CA": LocalePack(
        ...
        name="RetroRapid: Arcade Racer",
        subtitle="Dodge Traffic Across 3 Lanes",
        keywords="scoreboard,chase,watch,game,reflex,classic,pixel,vintage,boost,nostalgia,endless,quick,mobile,ipad",
        promotional_text="Dodge traffic and chase high scores in quick retro races, with Game Center, Apple Watch support, and accessibility-first controls.",
        description="""RetroRapid! is a fast 3-lane arcade racer built for quick sessions and high-score chasing.
