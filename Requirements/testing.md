...
- `./retrorapid assets app-icons --check` regenerates Pocket/LCD/Cartridge/CRT/Disc layers, including CRT's transparent combined scanline/vignette overlays plus Disc's transparent circuit environment, copies the approved Special Edition Default/Dark sources in memory, and compares package artwork plus single-image-set adaptive preview pairs without overwriting Icon Composer styling.
