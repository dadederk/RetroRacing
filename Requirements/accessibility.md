...
- **Challenge modal actions:** Challenge modal includes `Done` and `Other challenges` actions with semantic labels; on macOS an additional top-toolbar `Done` action is provided for easier dismissal.
