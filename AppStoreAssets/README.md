...
Themed documentation for App Store copy, ASO, screenshots, rollout, and execution. Split from the former monolithic reference so agents and humans can jump straight to the relevant section.

**Start here** if you are unsure where to look. The legacy filename [RETRORAPID_APP_STORE_REFERENCE.md](RETRORAPID_APP_STORE_REFERENCE.md) redirects to this hub.
...
- [Xarra App Store reference](../../Xarra/AppStoreAssets/README.md) (portfolio pattern)
- [GAAD nomination draft](../Docs/GAADYS_2026_RETRORAPID_NOMINATION_DRAFT.md)

## Scripts & assets

- `scripts/apply_retrorapid_metadata.py` — push staged fields to ASC 1.5 drafts via Helm
