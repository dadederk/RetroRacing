...
- Visual/manual checks cover the single Styles disclosure and gallery with and without Unlimited Plays, including selected, locked, and checking states; normal and grayscale gameplay; Increase Contrast; road mask rendering; light/dark appearance; and screenshot-capture fixtures.
