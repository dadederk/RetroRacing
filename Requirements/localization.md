...
- Alternate-icon gallery names, visual descriptions, states, errors, Debug toggle, and paywall benefit live in the shared String Catalog for every supported locale. New non-English copy remains `needs_review` until fluent approval.
