...
The themed files under AppStore/docs/ and Plans/aso/ are the canonical
...
REF = REPO / "AppStore" / "RETRORAPID_APP_STORE_REFERENCE.md"
GROWTH = REPO / "Plans" / "retrorapid_aso_growth_plan.md"
DOCS = REPO / "AppStore" / "docs"
ASO = REPO / "Plans" / "aso"
...
def split_growth_plan() -> None:
    ...
    write_aso(
        ...
        updated=updated,
        see_also=[
            ("Canonical metadata", "../../AppStore/docs/05-metadata-copy.md"),
            ("90-day plan", "../../AppStore/docs/11-execution-90-day.md"),
        ],
    )
    ...
    write_aso(
        ...
        updated=updated,
        see_also=[
            ("Current storyboard", "../../AppStore/docs/06-screenshots.md"),
        ],
    )
    ...
    write_aso(
        ...
        updated=updated,
        see_also=[
            ("Current staged copy", "../../AppStore/docs/05-metadata-copy.md"),
            ("Current strategy", "../../AppStore/docs/04-metadata-strategy.md"),
        ],
    )
    ...
    write_aso(
        ...
        updated=updated,
        see_also=[
            ("Current 90-day plan", "../../AppStore/docs/11-execution-90-day.md"),
        ],
    )
    ...
    write_aso(
        ...
        see_also=[
            ...
            ("Screenshots", "../../AppStore/docs/06-screenshots.md"),
        ],
    )
    ...
    write_aso(
        ...
        parent="../retrorapid_aso_growth_plan.md",
        updated=updated,
        see_also=[("App Store limits", "../../AppStore/docs/01-limits-and-sources.md")],
    )
    ...
    locale_body = (
        ...
        "[Country & Language Expansion](../../AppStore/docs/08-locale-expansion.md).\n"
    )
    write_aso(
        ...
        updated=updated,
        see_also=[
            ("Full expansion strategy", "../../AppStore/docs/08-locale-expansion.md"),
        ],
    )
