...
- The asset audit verifies package-local references, PNG/SVG dimensions, SVG view boxes, group limits and ordering, explicit document-level Default/Dark/Tinted fills, flat Default/Dark/Tinted image-name specializations, the absence of ignored nested specialization slots, adaptive gallery preview mappings, canonical generated-output drift, build-setting declarations, and shared catalog mappings. Full Release audit also verifies generated `CFBundleAlternateIcons`.
