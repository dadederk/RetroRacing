...
| Alternate app icons | [alternate_app_icon_plan.md](alternate_app_icon_plan.md) | In-progress Unlimited Plays cosmetic benefit for iPhone and iPad; Pocket/LCD/Cartridge/CRT/Disc are layered, the two Special Editions use approved v4 Default/Dark artwork, and Polygon remains to convert. |
