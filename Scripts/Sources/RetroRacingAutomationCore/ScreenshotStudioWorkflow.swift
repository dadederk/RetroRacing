...
private let slides: [SlideCopy] = [
    ...
    SlideCopy(byLocale: [
        ...
        "fr-CA": ("Choisissez Votre Style Rétro", "Passez du vert console de poche au style LCD portable."),
        ...
        "pt-PT": ("Escolha O Seu Visual Retrô", "Alterne entre verde pocket-console e estilo LCD portátil."),
        "zh-Hant": ("選擇復古風格", "在掌機綠與 LCD 手持風格間切換。"),
        "zh-Hans": ("选择复古风格", "在掌机绿与 LCD 手持风格间切换。"),
    ]),
    SlideCopy(byLocale: [
